---
title: "Lesson 01"
output: [github_document, pdf_document, html_document]
---
...
**Exercise**:
  ...
  * calculate the scalar product of $\begin{pmatrix}1\\1\\2\end{pmatrix}$ and $\begin{pmatrix}4\\2\\3\end{pmatrix}$. How can you realize it in a simple form with the known commands?
