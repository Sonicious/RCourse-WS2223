...
tt <- t2m_ras_new[[1]]
tt <- rotate(tt)
extend(tt,c(-180.125,180.125, -90.125, 90.125))
ggplot() +
...
* Fix the problem through storing `t2m_ras_new[[1]]` to a variable, `rotate` the layer and change the `extend` accordingly
